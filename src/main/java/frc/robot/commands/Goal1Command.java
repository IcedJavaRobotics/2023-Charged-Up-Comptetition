...
public class Goal1Command extends CommandBase {
  ...
  public Goal1Command(DriveTrainSubsystem msubsystem, ArmSubsystem asubsystem, ClawSubsystem csubsystem, ExtendoSubsystem esubsystem) {
