...
public class SetSlotGoal6Command extends CommandBase {
  /** Creates a new SetSlotGoal6Command. */
  
  private final GlobalVariablesSubsystem globalVariablesSubsystem;

  public SetSlotGoal6Command(GlobalVariablesSubsystem subsystem) {
  ...
  public void execute() {
    ...
    globalVariablesSubsystem.slotGoal6();
