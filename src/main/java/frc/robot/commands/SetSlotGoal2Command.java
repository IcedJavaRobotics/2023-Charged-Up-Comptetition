...
public class SetSlotGoal2Command extends CommandBase {
  /** Creates a new SetSlotGoal2Command. */

  private final GlobalVariablesSubsystem globalVariablesSubsystem;

  public SetSlotGoal2Command(GlobalVariablesSubsystem subsystem) {
  ...
  public void execute() {
    ...
    globalVariablesSubsystem.slotGoal2();
