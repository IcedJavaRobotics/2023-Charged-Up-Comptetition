...
public class SetSlotGoal8Command extends CommandBase {
  /** Creates a new SetSlotGoal8Command. */
  
  private final GlobalVariablesSubsystem globalVariablesSubsystem;

  public SetSlotGoal8Command(GlobalVariablesSubsystem subsystem) {
  ...
  public void execute() {
    ...
    globalVariablesSubsystem.slotGoal8();
