...
public class MiddleConeCommand extends CommandBase {
  /** Creates a new MiddleConeCommand. */
  private final ExtendoSubsystem extendoSubsystem;
  private final ArmSubsystem armSubsystem;
  private final ClawSubsystem clawSubsystem;

  public MiddleConeCommand(ExtendoSubsystem eSubsystem, ArmSubsystem aSubsystem, ClawSubsystem cSubsystem) {
