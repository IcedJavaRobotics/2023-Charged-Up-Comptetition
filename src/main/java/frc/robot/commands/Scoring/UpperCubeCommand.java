...
public class UpperCubeCommand extends CommandBase {
  /** Creates a new HighCubeCommans. */
  private final ExtendoSubsystem extendoSubsystem;
  private final ArmSubsystem armSubsystem;
  private final ClawSubsystem clawSubsystem;

  public UpperCubeCommand(ExtendoSubsystem eSubsystem, ArmSubsystem aSubsystem, ClawSubsystem cSubsystem) {
