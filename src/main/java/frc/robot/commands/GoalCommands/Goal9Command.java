...
public class Goal9Command extends CommandBase {
  ...
  public Goal9Command(DriveTrainSubsystem msubsystem, ArmSubsystem asubsystem, ClawSubsystem csubsystem, ExtendoSubsystem esubsystem) {
