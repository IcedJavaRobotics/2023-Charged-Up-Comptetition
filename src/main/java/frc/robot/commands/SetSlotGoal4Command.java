...
public class SetSlotGoal4Command extends CommandBase {
  /** Creates a new SetSlotGoal4Command. */

  private final GlobalVariablesSubsystem globalVariablesSubsystem;

  public SetSlotGoal4Command(GlobalVariablesSubsystem subsystem) {
  ...
  public void execute() {
    ...
    globalVariablesSubsystem.slotGoal4();
