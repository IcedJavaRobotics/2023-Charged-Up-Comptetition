...
public class SetSlotGoal3Command extends CommandBase {
  /** Creates a new SetSlotGoal3Command. */

  private final GlobalVariablesSubsystem globalVariablesSubsystem;

  public SetSlotGoal3Command(GlobalVariablesSubsystem subsystem) {
  ...
  public void execute() {
    ...
    globalVariablesSubsystem.slotGoal3();
