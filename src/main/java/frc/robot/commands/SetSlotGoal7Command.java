...
public class SetSlotGoal7Command extends CommandBase {
  /** Creates a new SetSlotGoal7Command. */
  
  private final GlobalVariablesSubsystem globalVariablesSubsystem;

  public SetSlotGoal7Command(GlobalVariablesSubsystem subsystem) {
  ...
  public void execute() {
    ...
    globalVariablesSubsystem.slotGoal7();
